...
namespace Christoc.Com.Modules.SlidePresentation
{
    ...
    /// are accessible to your module's controls (that inherity from SlidePresentationSettingsBase
    /// 
    /// </summary>


    public class SlidePresentationSettingsBase : ModuleSettingsBase
    {
