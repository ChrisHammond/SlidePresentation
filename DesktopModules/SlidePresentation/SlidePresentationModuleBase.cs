...
namespace Christoc.Com.Modules.SlidePresentation
{
    ...
    /// are accessible to your module's controls (that inherity from SlidePresentationModuleBase
    /// 
    /// </summary>

    public class SlidePresentationModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
        ...
        protected void RegisterJavaScript()
        {
            ...
            ClientResourceManager.RegisterScript(Parent.Page, "/desktopmodules/SlidePresentation/Scripts/jmpress.js");
        }
