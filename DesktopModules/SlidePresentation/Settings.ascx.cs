...
namespace Christoc.Com.Modules.SlidePresentation
{
    ...
    /// 
    /// Because the control inherits from SlidePresentationSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : SlidePresentationSettingsBase
    {
        ...
        public override void LoadSettings()
        {
            try
            {
                ...
                {
                    //TODO: create setting for Slide Template(s)
